...
kino is a themeable React video player with a pluggable-provider architecture. The same translucent, keyboard-first UI sits over Mux, raw files, YouTube, Vimeo, and audio-driven scene lessons, all behind a small typed surface.
...
**01 — Pluggable providers.** One UI contract, many engines. Mux HLS, raw files, YouTube, Vimeo, and scene lessons all ship today.
...
const HIGHLIGHTS = [
  {
    ...
    detail:
      "One UI contract, many engines. Mux HLS, raw files, YouTube, Vimeo, and scene lessons all ship today.",
  },
  {
    n: "02",
    term: "Keyboard-first",
      ...
      <section className="flex flex-col gap-7 pt-2">
        ...
        <div>
          ...
          <p className="mt-6 max-w-[56ch] text-lg/8 text-pretty text-paper-dim">
            ...
            raw files, YouTube, Vimeo, and audio-driven scene lessons, all
